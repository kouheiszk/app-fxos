    ...
    var getFriends = function() {
        ...
        .bind(ns.promise(function(next, value) {
            ...
            for(var i = 0; i < value.entry.length; i++){
                ...
                var $friendImage = $('<aside class="pack-end"><img alt="placeholder" src="' + friendData.thumbnailUrl + '"></aside>');
                var $friendName = $('<a href="#"><p class="friendName">' + friendData.displayName + '</p></a>');
